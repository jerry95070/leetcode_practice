...
class CaramelDecorator : public IceCreamDecorator{
    public:
        ...
        string getDescription() const override{
            return iceCream->getDescription() + " with Carmel";
        }
...
int main(){
    ...
    << ", Cost: Rs." << vanillaIceCream->cost() << endl;


    IceCream* chocolateIceCream = new ChocolateDecorator(vanillaIceCream);
    cout << "Order: " << chocolateIceCream->getDescription()
    << ", Cost: Rs." << chocolateIceCream->cost() << endl;

    IceCream* caramelDecorator = new CaramelDecorator(chocolateIceCream);
    cout << "Order: " << caramelDecorator->getDescription()
    << ", Cost: Rs." << caramelDecorator->cost() << endl;

    delete vanillaIceCream;
    delete chocolateIceCream;
    delete caramelDecorator;
